...
describe('application integration', () => {
  ...
  it('initializes and supports the primary user interactions', async () => {
    ...
    expect(document.getElementById('about-version').textContent).toBe('1.2.0');
    await vi.waitFor(() => {
