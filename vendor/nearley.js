...
var hasRequiredNearleyLanguageBootstrapped;

function requireNearleyLanguageBootstrapped () {
	if (hasRequiredNearleyLanguageBootstrapped) return nearleyLanguageBootstrapped$1.exports;
	hasRequiredNearleyLanguageBootstrapped = 1;
	(function (module) {
	...
	} (nearleyLanguageBootstrapped$1));
	return nearleyLanguageBootstrapped$1.exports;
}

var compile$1 = compile$2.exports;

var hasRequiredCompile;

function requireCompile () {
	if (hasRequiredCompile) return compile$2.exports;
	hasRequiredCompile = 1;
	(function (module) {
		(function(root, factory) {
		    if (module.exports) {
		        module.exports = factory(requireNearley());
		    } else {
		        root.Compile = factory(root.nearley);
		    }
		}(compile$1, function(nearley) {
		        ...
		        for (var i = 0; i < structure.length; i++) {
		            ...
		            if (productionRule.body) {
		                ...
		                if (!productionRule.builtin) {
		                    path = require$$1.resolve(
		                        opts.args[0] ? require$$1.dirname(opts.args[0]) : process.cwd(),
		                ...
		                if (opts.alreadycompiled.indexOf(path) === -1) {
		                    ...
		                    var f = require$$2.readFileSync(path).toString();
		                    var parserGrammar = nearley.Grammar.fromCompiled(requireNearleyLanguageBootstrapped());
	...
	return compile$2.exports;
}

var compileExports = requireCompile();
var compile = /*@__PURE__*/getDefaultExportFromCjs(compileExports);

var generate$2 = {exports: {}};

var generate$1 = generate$2.exports;

var hasRequiredGenerate;

function requireGenerate () {
	if (hasRequiredGenerate) return generate$2.exports;
	...
	return generate$2.exports;
}

var generateExports = requireGenerate();
var generate = /*@__PURE__*/getDefaultExportFromCjs(generateExports);

var nearleyLanguageBootstrappedExports = requireNearleyLanguageBootstrapped();
var nearleyLanguageBootstrapped = /*@__PURE__*/getDefaultExportFromCjs(nearleyLanguageBootstrappedExports);

export { nearleyLanguageBootstrapped as bootstrapped, compile, generate, nearley };
