...
function requireIndexMinimal () {
	...
	(function (exports) {
		...
		exports.BufferWriter = requireWriter_buffer();
		exports.Reader       = requireReader();
		exports.BufferReader = requireReader_buffer();

		// Utility
		exports.util         = requireMinimal();
		exports.rpc          = requireRpc();
		exports.roots        = requireRoots();
...
var require$$0 = /*@__PURE__*/getAugmentedNamespace(_browserBuiltinShim_fs);
...
function requireUtil () {
	 ...
	 */
	util$1.remove = function remove(object, value, key) {
	    if (!object)
	        return false;
	 ...
	 */
	util$1.jsonName = function jsonName(str) {
	    var result = "",
	        upperNext = false,
	        i = 0;
	    for (; i < str.length; ++i) {
...
function requireIndexLight () {
	...
	(function (module, exports) {
		exports = module.exports = requireIndexMinimal();
		...
		exports.verifier         = requireVerifier();
		exports.converter        = requireConverter();

		// Reflection
		exports.ReflectionObject = requireObject();
		exports.Namespace        = requireNamespace();
		exports.Root             = requireRoot();
		exports.Enum             = require_enum();
		exports.Type             = requireType();
		exports.Field            = requireField();
		exports.OneOf            = requireOneof();
		exports.MapField         = requireMapfield();
		exports.Service          = requireService();
		exports.Method           = requireMethod();

		// Runtime
		exports.Message          = requireMessage();
		exports.wrappers         = requireWrappers();
...
function requireSrc () {
	...
	hasRequiredSrc = 1;
	(function (module, exports) {
		exports = module.exports = requireIndexLight();

		exports.build = "full";

		// Parser
		exports.tokenize         = requireTokenize();
		exports.parse            = requireParse();
		exports.common           = requireCommon();
...
var index = /*@__PURE__*/getDefaultExportFromCjs(protobufjsExports);

export { index as protobuf };
